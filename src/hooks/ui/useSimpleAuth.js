...
const useSimpleAuth = () => {
    ...
    const isAuthenticated = () => localStorage.getItem("generator_token") !== null
        || sessionStorage.getItem("generator_token") !== null
    ...
    const logout = () => {
        ...
        localStorage.removeItem("generator_token")
        sessionStorage.removeItem("generator_token")
    }

    const getCurrentUser = () => {
        const encoded = localStorage.getItem("generator_token")
